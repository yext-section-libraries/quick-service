...
const fields: YextFields<QuickServiceAboutProps> = {
  section: {
    label: "Section",
    type: "object",
    objectFields: {
...
const defaultHeading: QuickServiceAboutProps["heading"] = {
  ...
  data: {
    text: {
      field: "",
      constantValue: "What is [[name]]?",
      constantValueEnabled: true,
    },
  },
};

const defaultSectionImage: QuickServiceAboutProps["sectionImage"] = {
  image: {
    field: "",
    constantValue: {
...
const defaultContent: QuickServiceAboutProps["content"] = {
  ...
  data: {
    text: {
      ...
      constantValue: {
        defaultValue:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus, urna eu feugiat efficitur, metus lectus fermentum magna, in suscipit lectus risus sed massa. Integer at eros non sapien gravida aliquet.\n\nPraesent vitae sem et ipsum sagittis scelerisque. Sed volutpat, nibh vitae fermentum ultricies, odio nunc condimentum tellus, vitae fringilla velit mi sed justo. Curabitur sodales libero vel augue sollicitudin, vitae mollis tortor pretium.\n\nMauris pulvinar, felis nec interdum lacinia, nisl lorem gravida tellus, vitae eleifend massa lorem nec risus. Nunc aliquet ligula at dui ultrices, eget pharetra nunc pellentesque.",
      },
      constantValueEnabled: true,
    },
  },
...
const defaultAboutProps: QuickServiceAboutProps = {
  section: {
    backgroundColor: {
...
const QuickServiceAboutComponent: PuckComponent<QuickServiceAboutProps> = (
  props,
) => {
  ...
  return (
    <AnalyticsScopeProvider
      name={`QuickServiceAbout${getAnalyticsScopeHash(props.id)}`}
    >
      <VisibilityWrapper
      ...
      >
        <>
          <style>{QuickServiceAboutStyles}</style>
          <Background
            as="section"
            background={props.section.backgroundColor}
            className="quick-service-about-section"
            aria-label="About"
            style={sectionSurfaceStyle}
          >
            <div className="quick-service-about-wrap">
              <div className="split-banner-heading quick-service-about-heading">
                <EntityField
                  displayName="Heading"
              ...
              <div className="quick-service-about-body">
                {selectedSectionImage ? (
                  <article className="quick-service-about-image">
                    <EntityField
                ...
                <article className="quick-service-about-text">
                  <EntityField
                    displayName="Content"
